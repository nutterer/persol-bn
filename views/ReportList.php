...
<form name="freportlistsrch" id="freportlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
<div id="freportlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<form name="freportlist" id="freportlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Report_Id->Visible) { // Report_Id ?>
        <th data-name="Report_Id" class="<?= $Page->Report_Id->headerCellClass() ?>"><div id="elh_report_Report_Id" class="report_Report_Id"><?= $Page->renderSort($Page->Report_Id) ?></div></th>
<?php } ?>
<?php if ($Page->Report_Year->Visible) { // Report_Year ?>
        <th data-name="Report_Year" class="<?= $Page->Report_Year->headerCellClass() ?>"><div id="elh_report_Report_Year" class="report_Report_Year"><?= $Page->renderSort($Page->Report_Year) ?></div></th>
<?php } ?>
<?php if ($Page->Report_File->Visible) { // Report_File ?>
        <th data-name="Report_File" class="<?= $Page->Report_File->headerCellClass() ?>"><div id="elh_report_Report_File" class="report_Report_File"><?= $Page->renderSort($Page->Report_File) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_report_Report_Id">
...
<span id="el<?= $Page->RowCount ?>_report_Report_Year">
...
<span id="el<?= $Page->RowCount ?>_report_Report_File">
