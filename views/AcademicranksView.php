...
// Page object
$AcademicranksView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var facademicranksview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    facademicranksview = currentForm = new ew.Form("facademicranksview", "view");
    loadjs.done("facademicranksview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="facademicranksview" id="facademicranksview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Aca_Id->Visible) { // Aca_Id ?>
    <tr id="r_Aca_Id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_Id"><?= $Page->Aca_Id->caption() ?></span></td>
        <td data-name="Aca_Id" <?= $Page->Aca_Id->cellAttributes() ?>>
<span id="el_academicranks_Aca_Id">
...
<?php if ($Page->Per_Id->Visible) { // Per_Id ?>
    <tr id="r_Per_Id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Per_Id"><?= $Page->Per_Id->caption() ?></span></td>
...
<?php if ($Page->Aca_RequesDate->Visible) { // Aca_RequesDate ?>
    <tr id="r_Aca_RequesDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_RequesDate"><?= $Page->Aca_RequesDate->caption() ?></span></td>
...
<?php if ($Page->Aca_AcceptDate->Visible) { // Aca_AcceptDate ?>
    <tr id="r_Aca_AcceptDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_AcceptDate"><?= $Page->Aca_AcceptDate->caption() ?></span></td>
...
<?php if ($Page->Aca_EstimateStart->Visible) { // Aca_EstimateStart ?>
    <tr id="r_Aca_EstimateStart">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_EstimateStart"><?= $Page->Aca_EstimateStart->caption() ?></span></td>
...
<?php if ($Page->Aca_EstimateEnd->Visible) { // Aca_EstimateEnd ?>
    <tr id="r_Aca_EstimateEnd">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_EstimateEnd"><?= $Page->Aca_EstimateEnd->caption() ?></span></td>
...
<?php if ($Page->Aca_Name->Visible) { // Aca_Name ?>
    <tr id="r_Aca_Name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_Name"><?= $Page->Aca_Name->caption() ?></span></td>
...
<?php if ($Page->Aca_Status->Visible) { // Aca_Status ?>
    <tr id="r_Aca_Status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_Status"><?= $Page->Aca_Status->caption() ?></span></td>
...
<?php if ($Page->Aca_SkillMajor->Visible) { // Aca_SkillMajor ?>
    <tr id="r_Aca_SkillMajor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_SkillMajor"><?= $Page->Aca_SkillMajor->caption() ?></span></td>
...
<?php if ($Page->Aca_Report->Visible) { // Aca_Report ?>
    <tr id="r_Aca_Report">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_Report"><?= $Page->Aca_Report->caption() ?></span></td>
...
<?php if ($Page->Aca_EstimateTeaching->Visible) { // Aca_EstimateTeaching ?>
    <tr id="r_Aca_EstimateTeaching">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_EstimateTeaching"><?= $Page->Aca_EstimateTeaching->caption() ?></span></td>
...
<?php if ($Page->Aca_EstimateBook->Visible) { // Aca_EstimateBook ?>
    <tr id="r_Aca_EstimateBook">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_EstimateBook"><?= $Page->Aca_EstimateBook->caption() ?></span></td>
...
<?php if ($Page->Aca_EstimateNum->Visible) { // Aca_EstimateNum ?>
    <tr id="r_Aca_EstimateNum">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_academicranks_Aca_EstimateNum"><?= $Page->Aca_EstimateNum->caption() ?></span></td>
