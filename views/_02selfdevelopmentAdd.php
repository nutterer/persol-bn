...
var f_02selfdevelopmentadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    f_02selfdevelopmentadd = currentForm = new ew.Form("f_02selfdevelopmentadd", "add");

    // Add fields
    var fields = ew.vars.tables._02selfdevelopment.fields;
    f_02selfdevelopmentadd.addFields([
    ...
    // Validate form
    f_02selfdevelopmentadd.validate = function () {
    ...
    // Form_CustomValidate
    f_02selfdevelopmentadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    f_02selfdevelopmentadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    f_02selfdevelopmentadd.lists.Per_Id = <?= $Page->Per_Id->toClientList($Page) ?>;
    f_02selfdevelopmentadd.lists.SelfDev_Type = <?= $Page->SelfDev_Type->toClientList($Page) ?>;
    loadjs.done("f_02selfdevelopmentadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="f_02selfdevelopmentadd" id="f_02selfdevelopmentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["f_02selfdevelopmentadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_02selfdevelopmentadd", "x_SelfDev_StartDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_02selfdevelopmentadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_02selfdevelopmentadd", "x_SelfDev_EndDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
