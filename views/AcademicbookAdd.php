...
loadjs.ready("head", function () {
    ...
    // Validate form
    facademicbookadd.validate = function () {
    ...
    // Form_CustomValidate
    facademicbookadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    facademicbookadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    facademicbookadd.lists.Aca_Id = <?= $Page->Aca_Id->toClientList($Page) ?>;
    facademicbookadd.lists.Book_Type = <?= $Page->Book_Type->toClientList($Page) ?>;
    loadjs.done("facademicbookadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="facademicbookadd" id="facademicbookadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" name="fa_x_Book_Cover" id= "fa_x_Book_Cover" value="0">
...
<input type="hidden" name="fa_x_Book_File" id= "fa_x_Book_File" value="0">
