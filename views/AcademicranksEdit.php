...
loadjs.ready("head", function () {
    ...
    // Validate form
    facademicranksedit.validate = function () {
    ...
    // Form_CustomValidate
    facademicranksedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    facademicranksedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("facademicranksedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="facademicranksedit" id="facademicranksedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Aca_Id->Visible) { // Aca_Id ?>
    <div id="r_Aca_Id" class="form-group row">
        <label id="elh_academicranks_Aca_Id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_Id->caption() ?><?= $Page->Aca_Id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="academicranks" data-field="x_Aca_Id" data-hidden="1" name="x_Aca_Id" id="x_Aca_Id" value="<?= HtmlEncode($Page->Aca_Id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["facademicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("facademicranksedit", "x_Aca_RequesDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["facademicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("facademicranksedit", "x_Aca_AcceptDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["facademicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("facademicranksedit", "x_Aca_EstimateStart", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["facademicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("facademicranksedit", "x_Aca_EstimateEnd", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["facademicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("facademicranksedit", "x_Aca_Report", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
