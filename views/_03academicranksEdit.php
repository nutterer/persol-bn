...
// Page object
$_03academicranksEdit = &$Page;
?>
<script>
if (!ew.vars.tables._03academicranks) ew.vars.tables._03academicranks = <?= JsonEncode(GetClientVar("tables", "_03academicranks")) ?>;
var currentForm, currentPageID;
var f_03academicranksedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    f_03academicranksedit = currentForm = new ew.Form("f_03academicranksedit", "edit");

    // Add fields
    var fields = ew.vars.tables._03academicranks.fields;
    f_03academicranksedit.addFields([
    ...
    // Validate form
    f_03academicranksedit.validate = function () {
    ...
    // Form_CustomValidate
    f_03academicranksedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    f_03academicranksedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    f_03academicranksedit.lists.Per_Id = <?= $Page->Per_Id->toClientList($Page) ?>;
    loadjs.done("f_03academicranksedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="f_03academicranksedit" id="f_03academicranksedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Aca_Id->Visible) { // Aca_Id ?>
    <div id="r_Aca_Id" class="form-group row">
        <label id="elh__03academicranks_Aca_Id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_Id->caption() ?><?= $Page->Aca_Id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Aca_Id->getDisplayValue($Page->Aca_Id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="_03academicranks" data-field="x_Aca_Id" data-hidden="1" name="x_Aca_Id" id="x_Aca_Id" value="<?= HtmlEncode($Page->Aca_Id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Per_Id->Visible) { // Per_Id ?>
    <div id="r_Per_Id" class="form-group row">
        <label id="elh__03academicranks_Per_Id" for="x_Per_Id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Per_Id->caption() ?><?= $Page->Per_Id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el__03academicranks_Per_Id">
    <select
        ...
        data-select2-id="_03academicranks_x_Per_Id"
        data-table="_03academicranks"
        data-field="x_Per_Id"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='_03academicranks_x_Per_Id']"),
        options = { name: "x_Per_Id", selectId: "_03academicranks_x_Per_Id", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables._03academicranks.fields.Per_Id.selectOptions);
...
<script>
loadjs.ready(["f_03academicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksedit", "x_Aca_RequesDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksedit", "x_Aca_AcceptDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksedit", "x_Aca_EstimateStart", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksedit", "x_Aca_EstimateEnd", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->Aca_Name->Visible) { // Aca_Name ?>
    <div id="r_Aca_Name" class="form-group row">
        <label id="elh__03academicranks_Aca_Name" for="x_Aca_Name" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_Name->caption() ?><?= $Page->Aca_Name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Aca_Name->cellAttributes() ?>>
<span id="el__03academicranks_Aca_Name">
<input type="<?= $Page->Aca_Name->getInputTextType() ?>" data-table="_03academicranks" data-field="x_Aca_Name" name="x_Aca_Name" id="x_Aca_Name" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->Aca_Name->getPlaceHolder()) ?>" value="<?= $Page->Aca_Name->EditValue ?>"<?= $Page->Aca_Name->editAttributes() ?> aria-describedby="x_Aca_Name_help">
...
<?php if ($Page->Aca_Status->Visible) { // Aca_Status ?>
    <div id="r_Aca_Status" class="form-group row">
        <label id="elh__03academicranks_Aca_Status" for="x_Aca_Status" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_Status->caption() ?><?= $Page->Aca_Status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Aca_Status->cellAttributes() ?>>
<span id="el__03academicranks_Aca_Status">
<input type="<?= $Page->Aca_Status->getInputTextType() ?>" data-table="_03academicranks" data-field="x_Aca_Status" name="x_Aca_Status" id="x_Aca_Status" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->Aca_Status->getPlaceHolder()) ?>" value="<?= $Page->Aca_Status->EditValue ?>"<?= $Page->Aca_Status->editAttributes() ?> aria-describedby="x_Aca_Status_help">
...
<?php if ($Page->Aca_Report->Visible) { // Aca_Report ?>
    <div id="r_Aca_Report" class="form-group row">
        <label id="elh__03academicranks_Aca_Report" for="x_Aca_Report" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_Report->caption() ?><?= $Page->Aca_Report->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Aca_Report->cellAttributes() ?>>
<span id="el__03academicranks_Aca_Report">
<input type="<?= $Page->Aca_Report->getInputTextType() ?>" data-table="_03academicranks" data-field="x_Aca_Report" name="x_Aca_Report" id="x_Aca_Report" placeholder="<?= HtmlEncode($Page->Aca_Report->getPlaceHolder()) ?>" value="<?= $Page->Aca_Report->EditValue ?>"<?= $Page->Aca_Report->editAttributes() ?> aria-describedby="x_Aca_Report_help">
...
<script>
loadjs.ready(["f_03academicranksedit", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksedit", "x_Aca_Report", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->Aca_EstimateTeaching->Visible) { // Aca_EstimateTeaching ?>
    <div id="r_Aca_EstimateTeaching" class="form-group row">
        <label id="elh__03academicranks_Aca_EstimateTeaching" for="x_Aca_EstimateTeaching" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Aca_EstimateTeaching->caption() ?><?= $Page->Aca_EstimateTeaching->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready("head", function() {
    ew.addEventHandlers("_03academicranks");
});
</script>
<script>
