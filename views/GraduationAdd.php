...
loadjs.ready("head", function () {
    ...
    fgraduationadd = currentForm = new ew.Form("fgraduationadd", "add");

    // Add fields
    var fields = ew.vars.tables.graduation.fields;
    fgraduationadd.addFields([
    ...
    // Validate form
    fgraduationadd.validate = function () {
    ...
    // Form_CustomValidate
    fgraduationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgraduationadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fgraduationadd.lists.Per_Id = <?= $Page->Per_Id->toClientList($Page) ?>;
    fgraduationadd.lists.Grad_Admission = <?= $Page->Grad_Admission->toClientList($Page) ?>;
    loadjs.done("fgraduationadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fgraduationadd" id="fgraduationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fgraduationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fgraduationadd", "x_Grad_Start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fgraduationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fgraduationadd", "x_Grad_End", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
