...
loadjs.ready("head", function () {
    ...
    fper_typeadd = currentForm = new ew.Form("fper_typeadd", "add");

    // Add fields
    var fields = ew.vars.tables.per_type.fields;
    fper_typeadd.addFields([
    ...
    // Validate form
    fper_typeadd.validate = function () {
    ...
    // Form_CustomValidate
    fper_typeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fper_typeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fper_typeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fper_typeadd" id="fper_typeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
