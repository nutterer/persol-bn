...
loadjs.ready("head", function () {
    ...
    // Validate form
    f_03academicranksadd.validate = function () {
    ...
    // Form_CustomValidate
    f_03academicranksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    f_03academicranksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    f_03academicranksadd.lists.Per_Id = <?= $Page->Per_Id->toClientList($Page) ?>;
    loadjs.done("f_03academicranksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="f_03academicranksadd" id="f_03academicranksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["f_03academicranksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksadd", "x_Aca_RequesDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksadd", "x_Aca_AcceptDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksadd", "x_Aca_EstimateStart", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksadd", "x_Aca_EstimateEnd", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["f_03academicranksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("f_03academicranksadd", "x_Aca_Report", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
