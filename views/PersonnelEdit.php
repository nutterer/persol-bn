...
loadjs.ready("head", function () {
    ...
    fpersonneledit = currentForm = new ew.Form("fpersonneledit", "edit");

    // Add fields
    var fields = ew.vars.tables.personnel.fields;
    fpersonneledit.addFields([
    ...
    // Validate form
    fpersonneledit.validate = function () {
    ...
    // Form_CustomValidate
    fpersonneledit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpersonneledit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpersonneledit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpersonneledit" id="fpersonneledit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="personnel" data-field="x_Per_Id" data-hidden="1" name="o_Per_Id" id="o_Per_Id" value="<?= HtmlEncode($Page->Per_Id->OldValue ?? $Page->Per_Id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fpersonneledit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonneledit", "x_Per_WorDateStart", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpersonneledit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonneledit", "x_Per_WorkDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpersonneledit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpersonneledit", "x_Per_Born", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
