...
loadjs.ready("head", function () {
    ...
    fbook_typeadd = currentForm = new ew.Form("fbook_typeadd", "add");

    // Add fields
    var fields = ew.vars.tables.book_type.fields;
    fbook_typeadd.addFields([
    ...
    // Validate form
    fbook_typeadd.validate = function () {
    ...
    // Form_CustomValidate
    fbook_typeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbook_typeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fbook_typeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fbook_typeadd" id="fbook_typeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
