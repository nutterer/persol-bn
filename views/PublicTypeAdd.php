...
loadjs.ready("head", function () {
    ...
    fpublic_typeadd = currentForm = new ew.Form("fpublic_typeadd", "add");

    // Add fields
    var fields = ew.vars.tables.public_type.fields;
    fpublic_typeadd.addFields([
    ...
    // Validate form
    fpublic_typeadd.validate = function () {
    ...
    // Form_CustomValidate
    fpublic_typeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpublic_typeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpublic_typeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpublic_typeadd" id="fpublic_typeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
