...
Object.assign(ew, {
    ...
    MAX_EMAIL_RECIPIENT: <?= Config("MAX_EMAIL_RECIPIENT") ?>,
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/UPLogo.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/UPLogo.ico">
...
</div><div class="modal-footer"><button type="button" class="btn btn-primary ew-btn"><?= $Language->phrase("SendEmailBtn") ?></button><button type="button" class="btn btn-default ew-btn" data-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button></div></div></div></div>
<!-- import dialog -->
