...
// Page object
$PerEmployeetypeEdit = &$Page;
?>
<script>
if (!ew.vars.tables.per_employeetype) ew.vars.tables.per_employeetype = <?= JsonEncode(GetClientVar("tables", "per_employeetype")) ?>;
var currentForm, currentPageID;
var fper_employeetypeedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fper_employeetypeedit = currentForm = new ew.Form("fper_employeetypeedit", "edit");

    // Add fields
    var fields = ew.vars.tables.per_employeetype.fields;
    fper_employeetypeedit.addFields([
        ["Per_EmployeeType_id", [fields.Per_EmployeeType_id.required ? ew.Validators.required(fields.Per_EmployeeType_id.caption) : null], fields.Per_EmployeeType_id.isInvalid],
    ...
    // Validate form
    fper_employeetypeedit.validate = function () {
    ...
    // Form_CustomValidate
    fper_employeetypeedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fper_employeetypeedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fper_employeetypeedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fper_employeetypeedit" id="fper_employeetypeedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Per_EmployeeType_id->Visible) { // Per_EmployeeType_id ?>
    <div id="r_Per_EmployeeType_id" class="form-group row">
        <label id="elh_per_employeetype_Per_EmployeeType_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Per_EmployeeType_id->caption() ?><?= $Page->Per_EmployeeType_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Per_EmployeeType_id->cellAttributes() ?>>
<span id="el_per_employeetype_Per_EmployeeType_id">
<span<?= $Page->Per_EmployeeType_id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Per_EmployeeType_id->getDisplayValue($Page->Per_EmployeeType_id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="per_employeetype" data-field="x_Per_EmployeeType_id" data-hidden="1" name="x_Per_EmployeeType_id" id="x_Per_EmployeeType_id" value="<?= HtmlEncode($Page->Per_EmployeeType_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
