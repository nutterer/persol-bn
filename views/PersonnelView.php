...
loadjs.ready("head", function () {
    ...
    fpersonnelview = currentForm = new ew.Form("fpersonnelview", "view");
    loadjs.done("fpersonnelview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpersonnelview" id="fpersonnelview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Per_Id->Visible) { // Per_Id ?>
    <tr id="r_Per_Id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Id"><?= $Page->Per_Id->caption() ?></span></td>
...
<?php if ($Page->Per_ThaiPre->Visible) { // Per_ThaiPre ?>
    <tr id="r_Per_ThaiPre">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_ThaiPre"><?= $Page->Per_ThaiPre->caption() ?></span></td>
...
<?php if ($Page->Per_ThaiName->Visible) { // Per_ThaiName ?>
    <tr id="r_Per_ThaiName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_ThaiName"><?= $Page->Per_ThaiName->caption() ?></span></td>
...
<?php if ($Page->Per_ThaiLastName->Visible) { // Per_ThaiLastName ?>
    <tr id="r_Per_ThaiLastName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_ThaiLastName"><?= $Page->Per_ThaiLastName->caption() ?></span></td>
...
<?php if ($Page->Per_EngPre->Visible) { // Per_EngPre ?>
    <tr id="r_Per_EngPre">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_EngPre"><?= $Page->Per_EngPre->caption() ?></span></td>
...
<?php if ($Page->Per_EngName->Visible) { // Per_EngName ?>
    <tr id="r_Per_EngName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_EngName"><?= $Page->Per_EngName->caption() ?></span></td>
...
<?php if ($Page->Per_EngLastName->Visible) { // Per_EngLastName ?>
    <tr id="r_Per_EngLastName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_EngLastName"><?= $Page->Per_EngLastName->caption() ?></span></td>
...
<?php if ($Page->Per_Type->Visible) { // Per_Type ?>
    <tr id="r_Per_Type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Type"><?= $Page->Per_Type->caption() ?></span></td>
...
<?php if ($Page->Per_EmployeeType->Visible) { // Per_EmployeeType ?>
    <tr id="r_Per_EmployeeType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_EmployeeType"><?= $Page->Per_EmployeeType->caption() ?></span></td>
...
<?php if ($Page->Per_Position->Visible) { // Per_Position ?>
    <tr id="r_Per_Position">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Position"><?= $Page->Per_Position->caption() ?></span></td>
...
<?php if ($Page->Per_Academic->Visible) { // Per_Academic ?>
    <tr id="r_Per_Academic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Academic"><?= $Page->Per_Academic->caption() ?></span></td>
...
<?php if ($Page->Per_Administrative->Visible) { // Per_Administrative ?>
    <tr id="r_Per_Administrative">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Administrative"><?= $Page->Per_Administrative->caption() ?></span></td>
...
<?php if ($Page->Per_WorDateStart->Visible) { // Per_WorDateStart ?>
    <tr id="r_Per_WorDateStart">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_WorDateStart"><?= $Page->Per_WorDateStart->caption() ?></span></td>
...
<?php if ($Page->Per_WorkDate->Visible) { // Per_WorkDate ?>
    <tr id="r_Per_WorkDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_WorkDate"><?= $Page->Per_WorkDate->caption() ?></span></td>
...
<?php if ($Page->Per_WorkStatus->Visible) { // Per_WorkStatus ?>
    <tr id="r_Per_WorkStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_WorkStatus"><?= $Page->Per_WorkStatus->caption() ?></span></td>
...
<?php if ($Page->Per_Born->Visible) { // Per_Born ?>
    <tr id="r_Per_Born">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Born"><?= $Page->Per_Born->caption() ?></span></td>
...
<?php if ($Page->Per_Nationality->Visible) { // Per_Nationality ?>
    <tr id="r_Per_Nationality">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Nationality"><?= $Page->Per_Nationality->caption() ?></span></td>
...
<?php if ($Page->Per_Religion->Visible) { // Per_Religion ?>
    <tr id="r_Per_Religion">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Religion"><?= $Page->Per_Religion->caption() ?></span></td>
...
<?php if ($Page->Per_IdCard->Visible) { // Per_IdCard ?>
    <tr id="r_Per_IdCard">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_IdCard"><?= $Page->Per_IdCard->caption() ?></span></td>
...
<?php if ($Page->Per_Phone->Visible) { // Per_Phone ?>
    <tr id="r_Per_Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Phone"><?= $Page->Per_Phone->caption() ?></span></td>
...
<?php if ($Page->Per_UPEmail->Visible) { // Per_UPEmail ?>
    <tr id="r_Per_UPEmail">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_UPEmail"><?= $Page->Per_UPEmail->caption() ?></span></td>
...
<?php if ($Page->Per_Email->Visible) { // Per_Email ?>
    <tr id="r_Per_Email">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Email"><?= $Page->Per_Email->caption() ?></span></td>
...
<?php if ($Page->Per_Address->Visible) { // Per_Address ?>
    <tr id="r_Per_Address">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_personnel_Per_Address"><?= $Page->Per_Address->caption() ?></span></td>
