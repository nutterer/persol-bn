 ...
 * Page class
 */
class SelfdevelopmentAdd extends Selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SelfdevelopmentAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("SelfdevelopmentList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "SelfdevelopmentList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "SelfdevelopmentView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->SelfDev_Id->OldValue = $this->SelfDev_Id->CurrentValue;
        $this->Per_Id->CurrentValue = null;
        $this->Per_Id->OldValue = $this->Per_Id->CurrentValue;
        $this->SelfDev_Type->CurrentValue = null;
        $this->SelfDev_Type->OldValue = $this->SelfDev_Type->CurrentValue;
        $this->SelfDev_Name->CurrentValue = null;
        $this->SelfDev_Name->OldValue = $this->SelfDev_Name->CurrentValue;
        $this->SelfDev_StartDate->CurrentValue = null;
        $this->SelfDev_StartDate->OldValue = $this->SelfDev_StartDate->CurrentValue;
        $this->SelfDev_EndDate->CurrentValue = null;
        $this->SelfDev_EndDate->OldValue = $this->SelfDev_EndDate->CurrentValue;
        $this->SelfDev_Money->CurrentValue = null;
        $this->SelfDev_Money->OldValue = $this->SelfDev_Money->CurrentValue;
        $this->SelfDev_Address->CurrentValue = null;
        $this->SelfDev_Address->OldValue = $this->SelfDev_Address->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['SelfDev_Id'] = $this->SelfDev_Id->CurrentValue;
        $row['Per_Id'] = $this->Per_Id->CurrentValue;
        $row['SelfDev_Type'] = $this->SelfDev_Type->CurrentValue;
        $row['SelfDev_Name'] = $this->SelfDev_Name->CurrentValue;
        $row['SelfDev_StartDate'] = $this->SelfDev_StartDate->CurrentValue;
        $row['SelfDev_EndDate'] = $this->SelfDev_EndDate->CurrentValue;
        $row['SelfDev_Money'] = $this->SelfDev_Money->CurrentValue;
        $row['SelfDev_Address'] = $this->SelfDev_Address->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->SelfDev_Type->EditValue = HtmlEncode($this->SelfDev_Type->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // SelfDev_Type
        $this->SelfDev_Type->setDbValueDef($rsnew, $this->SelfDev_Type->CurrentValue, "", false);

        // SelfDev_Name
        $this->SelfDev_Name->setDbValueDef($rsnew, $this->SelfDev_Name->CurrentValue, "", false);

        // SelfDev_StartDate
        $this->SelfDev_StartDate->setDbValueDef($rsnew, UnFormatDateTime($this->SelfDev_StartDate->CurrentValue, 0), CurrentDate(), false);

        // SelfDev_EndDate
        $this->SelfDev_EndDate->setDbValueDef($rsnew, UnFormatDateTime($this->SelfDev_EndDate->CurrentValue, 0), CurrentDate(), false);

        // SelfDev_Money
        $this->SelfDev_Money->setDbValueDef($rsnew, $this->SelfDev_Money->CurrentValue, 0, false);

        // SelfDev_Address
        $this->SelfDev_Address->setDbValueDef($rsnew, $this->SelfDev_Address->CurrentValue, "", false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("SelfdevelopmentList"), "", $this->TableVar, true);
