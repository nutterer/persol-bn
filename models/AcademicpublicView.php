 ...
 * Page class
 */
class AcademicpublicView extends Academicpublic
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcademicpublicView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Public_Id") ?? Route("Public_Id")) !== null) {
            $this->RecKey["Public_Id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("Public_Id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("Public_Id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Public_Id") ?? Route("Public_Id")) !== null) {
                ...
                $this->RecKey["Public_Id"] = $this->Public_Id->QueryStringValue;
            } elseif (Post("Public_Id") !== null) {
                $this->Public_Id->setFormValue(Post("Public_Id"));
                $this->RecKey["Public_Id"] = $this->Public_Id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->Public_Id->setQueryStringValue($keyValue);
                $this->RecKey["Public_Id"] = $this->Public_Id->QueryStringValue;
            } else {
                $returnUrl = "AcademicpublicList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AcademicpublicList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "AcademicpublicList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.facademicpublicview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.facademicpublicview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.facademicpublicview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
