 ...
 * Page class
 */
class _02selfdevelopmentDelete extends _02selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "_02selfdevelopmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("_02selfdevelopmentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("_02selfdevelopmentList"); // Return to list
                return;
            }
        }
