 ...
 * Page class
 */
class _02selfdevelopmentAdd extends _02selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "_02selfdevelopmentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "_02selfdevelopmentView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // SelfDev_Type
        $this->SelfDev_Type->setDbValueDef($rsnew, $this->SelfDev_Type->CurrentValue, 0, false);
