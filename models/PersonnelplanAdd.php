 ...
 * Page class
 */
class PersonnelplanAdd extends Personnelplan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonnelplanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PersonnelplanView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->Plan_File->Upload->DbValue = null;
        $this->Plan_File->OldValue = $this->Plan_File->Upload->DbValue;
        $this->Plan_File->CurrentValue = null; // Clear file related field
    }
    ...
    protected function newRow()
    {
        ...
        $row['Plan_File'] = $this->Plan_File->Upload->DbValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->Plan_File->Visible && !$this->Plan_File->Upload->KeepFile) {
            $this->Plan_File->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Plan_File->Visible && !$this->Plan_File->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Plan_File->Upload->FileName)) {
                ...
                $this->Plan_File->setDbValueDef($rsnew, $this->Plan_File->Upload->FileName, "", false);
            }
        }
