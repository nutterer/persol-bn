...
/**
 * Table class for 03-academicranks
 */
class _03academicranks extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = '_03academicranks';
        $this->TableName = '03-academicranks';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`03-academicranks`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Aca_Id
        $this->Aca_Id = new DbField('_03academicranks', '03-academicranks', 'x_Aca_Id', 'Aca_Id', '`Aca_Id`', '`Aca_Id`', 3, 5, -1, false, '`Aca_Id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Per_Id
        $this->Per_Id = new DbField('_03academicranks', '03-academicranks', 'x_Per_Id', 'Per_Id', '`Per_Id`', '`Per_Id`', 3, 4, -1, false, '`Per_Id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Aca_RequesDate
        $this->Aca_RequesDate = new DbField('_03academicranks', '03-academicranks', 'x_Aca_RequesDate', 'Aca_RequesDate', '`Aca_RequesDate`', CastDateFieldForLike("`Aca_RequesDate`", 0, "DB"), 133, 10, 0, false, '`Aca_RequesDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_AcceptDate
        $this->Aca_AcceptDate = new DbField('_03academicranks', '03-academicranks', 'x_Aca_AcceptDate', 'Aca_AcceptDate', '`Aca_AcceptDate`', CastDateFieldForLike("`Aca_AcceptDate`", 0, "DB"), 133, 10, 0, false, '`Aca_AcceptDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_EstimateStart
        $this->Aca_EstimateStart = new DbField('_03academicranks', '03-academicranks', 'x_Aca_EstimateStart', 'Aca_EstimateStart', '`Aca_EstimateStart`', CastDateFieldForLike("`Aca_EstimateStart`", 0, "DB"), 133, 10, 0, false, '`Aca_EstimateStart`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_EstimateEnd
        $this->Aca_EstimateEnd = new DbField('_03academicranks', '03-academicranks', 'x_Aca_EstimateEnd', 'Aca_EstimateEnd', '`Aca_EstimateEnd`', CastDateFieldForLike("`Aca_EstimateEnd`", 0, "DB"), 133, 10, 0, false, '`Aca_EstimateEnd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_Name
        $this->Aca_Name = new DbField('_03academicranks', '03-academicranks', 'x_Aca_Name', 'Aca_Name', '`Aca_Name`', '`Aca_Name`', 200, 100, -1, false, '`Aca_Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_Status
        $this->Aca_Status = new DbField('_03academicranks', '03-academicranks', 'x_Aca_Status', 'Aca_Status', '`Aca_Status`', '`Aca_Status`', 200, 100, -1, false, '`Aca_Status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_SkillMajor
        $this->Aca_SkillMajor = new DbField('_03academicranks', '03-academicranks', 'x_Aca_SkillMajor', 'Aca_SkillMajor', '`Aca_SkillMajor`', '`Aca_SkillMajor`', 200, 100, -1, false, '`Aca_SkillMajor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_Report
        $this->Aca_Report = new DbField('_03academicranks', '03-academicranks', 'x_Aca_Report', 'Aca_Report', '`Aca_Report`', CastDateFieldForLike("`Aca_Report`", 0, "DB"), 133, 10, 0, false, '`Aca_Report`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Aca_EstimateTeaching = new DbField('_03academicranks', '03-academicranks', 'x_Aca_EstimateTeaching', 'Aca_EstimateTeaching', '`Aca_EstimateTeaching`', '`Aca_EstimateTeaching`', 200, 10, -1, false, '`Aca_EstimateTeaching`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_EstimateBook
        $this->Aca_EstimateBook = new DbField('_03academicranks', '03-academicranks', 'x_Aca_EstimateBook', 'Aca_EstimateBook', '`Aca_EstimateBook`', '`Aca_EstimateBook`', 200, 10, -1, false, '`Aca_EstimateBook`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aca_EstimateNum
        $this->Aca_EstimateNum = new DbField('_03academicranks', '03-academicranks', 'x_Aca_EstimateNum', 'Aca_EstimateNum', '`Aca_EstimateNum`', '`Aca_EstimateNum`', 200, 1, -1, false, '`Aca_EstimateNum`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`03-academicranks`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("_03academicranksList");
        }
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "_03academicranksEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "_03academicranksAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "_03academicranksView";
            case Config("API_ADD_ACTION"):
                return "_03academicranksAdd";
            case Config("API_EDIT_ACTION"):
                return "_03academicranksEdit";
            case Config("API_DELETE_ACTION"):
                return "_03academicranksDelete";
            case Config("API_LIST_ACTION"):
                return "_03academicranksList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("_03academicranksView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("_03academicranksView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "_03academicranksAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "_03academicranksAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("_03academicranksEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("_03academicranksAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("_03academicranksDelete", $this->getUrlParm());
    }
