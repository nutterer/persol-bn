...
/**
 * Table class for selfdevelopment
 */
class Selfdevelopment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'selfdevelopment';
        $this->TableName = 'selfdevelopment';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`selfdevelopment`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // SelfDev_Id
        $this->SelfDev_Id = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_Id', 'SelfDev_Id', '`SelfDev_Id`', '`SelfDev_Id`', 3, 11, -1, false, '`SelfDev_Id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Per_Id
        $this->Per_Id = new DbField('selfdevelopment', 'selfdevelopment', 'x_Per_Id', 'Per_Id', '`Per_Id`', '`Per_Id`', 3, 10, -1, false, '`Per_Id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Id->Lookup = new Lookup('Per_Id', 'personnel', false, 'Per_Id', ["Per_ThaiName","Per_ThaiLastName","",""], [], [], [], [], [], [], '', '');
        $this->Per_Id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Id'] = &$this->Per_Id;

        // SelfDev_Type
        $this->SelfDev_Type = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_Type', 'SelfDev_Type', '`SelfDev_Type`', '`SelfDev_Type`', 200, 20, -1, false, '`SelfDev_Type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SelfDev_Name
        $this->SelfDev_Name = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_Name', 'SelfDev_Name', '`SelfDev_Name`', '`SelfDev_Name`', 201, 256, -1, false, '`SelfDev_Name`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // SelfDev_StartDate
        $this->SelfDev_StartDate = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_StartDate', 'SelfDev_StartDate', '`SelfDev_StartDate`', CastDateFieldForLike("`SelfDev_StartDate`", 0, "DB"), 133, 10, 0, false, '`SelfDev_StartDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SelfDev_EndDate
        $this->SelfDev_EndDate = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_EndDate', 'SelfDev_EndDate', '`SelfDev_EndDate`', CastDateFieldForLike("`SelfDev_EndDate`", 0, "DB"), 133, 10, 0, false, '`SelfDev_EndDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SelfDev_Money
        $this->SelfDev_Money = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_Money', 'SelfDev_Money', '`SelfDev_Money`', '`SelfDev_Money`', 4, 12, -1, false, '`SelfDev_Money`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SelfDev_Address
        $this->SelfDev_Address = new DbField('selfdevelopment', 'selfdevelopment', 'x_SelfDev_Address', 'SelfDev_Address', '`SelfDev_Address`', '`SelfDev_Address`', 201, 256, -1, false, '`SelfDev_Address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`selfdevelopment`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("SelfdevelopmentList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "SelfdevelopmentView") {
            return $Language->phrase("View");
        } elseif ($pageName == "SelfdevelopmentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SelfdevelopmentAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SelfdevelopmentView";
            case Config("API_ADD_ACTION"):
                return "SelfdevelopmentAdd";
            case Config("API_EDIT_ACTION"):
                return "SelfdevelopmentEdit";
            case Config("API_DELETE_ACTION"):
                return "SelfdevelopmentDelete";
            case Config("API_LIST_ACTION"):
                return "SelfdevelopmentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SelfdevelopmentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SelfdevelopmentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SelfdevelopmentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SelfdevelopmentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SelfdevelopmentEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SelfdevelopmentAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("SelfdevelopmentDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->SelfDev_Type->Raw) {
            $this->SelfDev_Type->CurrentValue = HtmlDecode($this->SelfDev_Type->CurrentValue);
        }
        $this->SelfDev_Type->EditValue = $this->SelfDev_Type->CurrentValue;
