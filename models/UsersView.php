...
class UsersView extends Users
{
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Users__Id") ?? Route("Users__Id")) !== null) {
            $this->RecKey["Users__Id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("Users__Id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("Users__Id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Users__Id") ?? Route("Users__Id")) !== null) {
                ...
                $this->RecKey["Users__Id"] = $this->Users__Id->QueryStringValue;
            } elseif (Post("Users__Id") !== null) {
                $this->Users__Id->setFormValue(Post("Users__Id"));
                $this->RecKey["Users__Id"] = $this->Users__Id->FormValue;
