 ...
 * Page class
 */
class _01personnelAdd extends _01personnel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "_01personnelAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "_01personnelView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->Per_major->CurrentValue = null;
        $this->Per_major->OldValue = $this->Per_major->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['Per_major'] = $this->Per_major->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Per_Type
        $this->Per_Type->setDbValueDef($rsnew, $this->Per_Type->CurrentValue, 0, false);

        // Per_EmployeeType
        $this->Per_EmployeeType->setDbValueDef($rsnew, $this->Per_EmployeeType->CurrentValue, 0, false);

        // Per_Position
        $this->Per_Position->setDbValueDef($rsnew, $this->Per_Position->CurrentValue, 0, false);

        // Per_major
        $this->Per_major->setDbValueDef($rsnew, $this->Per_major->CurrentValue, 0, false);

        // Per_Academic
        $this->Per_Academic->setDbValueDef($rsnew, $this->Per_Academic->CurrentValue, 0, false);

        // Per_Administrative
        $this->Per_Administrative->setDbValueDef($rsnew, $this->Per_Administrative->CurrentValue, 0, false);
        ...
        // Per_Nationality
        $this->Per_Nationality->setDbValueDef($rsnew, $this->Per_Nationality->CurrentValue, 0, false);

        // Per_Religion
        $this->Per_Religion->setDbValueDef($rsnew, $this->Per_Religion->CurrentValue, 0, false);

        // Per_IdCard
        $this->Per_IdCard->setDbValueDef($rsnew, $this->Per_IdCard->CurrentValue, "", false);

        // Per_WorkStatus
        $this->Per_WorkStatus->setDbValueDef($rsnew, $this->Per_WorkStatus->CurrentValue, 0, false);
