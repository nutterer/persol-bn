...
/**
 * Table class for 01-personnel
 */
class _01personnel extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = '_01personnel';
        $this->TableName = '01-personnel';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`01-personnel`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Per_Id
        $this->Per_Id = new DbField('_01personnel', '01-personnel', 'x_Per_Id', 'Per_Id', '`Per_Id`', '`Per_Id`', 3, 4, -1, false, '`Per_Id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_ThaiPre
        $this->Per_ThaiPre = new DbField('_01personnel', '01-personnel', 'x_Per_ThaiPre', 'Per_ThaiPre', '`Per_ThaiPre`', '`Per_ThaiPre`', 200, 100, -1, false, '`Per_ThaiPre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_ThaiName
        $this->Per_ThaiName = new DbField('_01personnel', '01-personnel', 'x_Per_ThaiName', 'Per_ThaiName', '`Per_ThaiName`', '`Per_ThaiName`', 200, 100, -1, false, '`Per_ThaiName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_ThaiLastName
        $this->Per_ThaiLastName = new DbField('_01personnel', '01-personnel', 'x_Per_ThaiLastName', 'Per_ThaiLastName', '`Per_ThaiLastName`', '`Per_ThaiLastName`', 200, 100, -1, false, '`Per_ThaiLastName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_EngPre
        $this->Per_EngPre = new DbField('_01personnel', '01-personnel', 'x_Per_EngPre', 'Per_EngPre', '`Per_EngPre`', '`Per_EngPre`', 200, 100, -1, false, '`Per_EngPre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_EngName
        $this->Per_EngName = new DbField('_01personnel', '01-personnel', 'x_Per_EngName', 'Per_EngName', '`Per_EngName`', '`Per_EngName`', 200, 100, -1, false, '`Per_EngName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_EngLastName
        $this->Per_EngLastName = new DbField('_01personnel', '01-personnel', 'x_Per_EngLastName', 'Per_EngLastName', '`Per_EngLastName`', '`Per_EngLastName`', 200, 100, -1, false, '`Per_EngLastName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_Type
        $this->Per_Type = new DbField('_01personnel', '01-personnel', 'x_Per_Type', 'Per_Type', '`Per_Type`', '`Per_Type`', 3, 2, -1, false, '`Per_Type`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Type->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Type->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Type->Lookup = new Lookup('Per_Type', 'per_type', false, 'Per_Type_id', ["Per_Type_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Type->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Type'] = &$this->Per_Type;

        // Per_EmployeeType
        $this->Per_EmployeeType = new DbField('_01personnel', '01-personnel', 'x_Per_EmployeeType', 'Per_EmployeeType', '`Per_EmployeeType`', '`Per_EmployeeType`', 3, 2, -1, false, '`Per_EmployeeType`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_EmployeeType->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_EmployeeType->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_EmployeeType->Lookup = new Lookup('Per_EmployeeType', 'per_employeetype', false, 'Per_EmployeeType_id', ["Per_EmployeeType_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_EmployeeType->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_EmployeeType'] = &$this->Per_EmployeeType;

        // Per_Position
        $this->Per_Position = new DbField('_01personnel', '01-personnel', 'x_Per_Position', 'Per_Position', '`Per_Position`', '`Per_Position`', 3, 2, -1, false, '`Per_Position`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Position->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Position->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Position->Lookup = new Lookup('Per_Position', 'per_position', false, 'Per_Position_id', ["Per_Position_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Position->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Position'] = &$this->Per_Position;

        // Per_major
        $this->Per_major = new DbField('_01personnel', '01-personnel', 'x_Per_major', 'Per_major', '`Per_major`', '`Per_major`', 3, 2, -1, false, '`Per_major`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->Per_major->Nullable = false; // NOT NULL field
        $this->Per_major->Required = true; // Required field
        $this->Per_major->Sortable = true; // Allow sort
        $this->Per_major->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_major->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_major->Lookup = new Lookup('Per_major', 'per_major', false, 'Per_major_id', ["Per_major_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_major->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_major'] = &$this->Per_major;

        // Per_Academic
        $this->Per_Academic = new DbField('_01personnel', '01-personnel', 'x_Per_Academic', 'Per_Academic', '`Per_Academic`', '`Per_Academic`', 3, 2, -1, false, '`Per_Academic`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Academic->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Academic->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Academic->Lookup = new Lookup('Per_Academic', 'per_academic', false, 'Per_Academic_id', ["Per_Academic_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Academic->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Academic'] = &$this->Per_Academic;

        // Per_Administrative
        $this->Per_Administrative = new DbField('_01personnel', '01-personnel', 'x_Per_Administrative', 'Per_Administrative', '`Per_Administrative`', '`Per_Administrative`', 3, 2, -1, false, '`Per_Administrative`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Administrative->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Administrative->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Administrative->Lookup = new Lookup('Per_Administrative', 'per_administrative', false, 'Per_Administrative_id', ["Per_Administrative_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Administrative->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Administrative'] = &$this->Per_Administrative;

        // Per_WorDateStart
        $this->Per_WorDateStart = new DbField('_01personnel', '01-personnel', 'x_Per_WorDateStart', 'Per_WorDateStart', '`Per_WorDateStart`', CastDateFieldForLike("`Per_WorDateStart`", 0, "DB"), 133, 10, 0, false, '`Per_WorDateStart`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_WorkDate
        $this->Per_WorkDate = new DbField('_01personnel', '01-personnel', 'x_Per_WorkDate', 'Per_WorkDate', '`Per_WorkDate`', CastDateFieldForLike("`Per_WorkDate`", 0, "DB"), 133, 10, 0, false, '`Per_WorkDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_Born
        $this->Per_Born = new DbField('_01personnel', '01-personnel', 'x_Per_Born', 'Per_Born', '`Per_Born`', CastDateFieldForLike("`Per_Born`", 0, "DB"), 133, 10, 0, false, '`Per_Born`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_Nationality
        $this->Per_Nationality = new DbField('_01personnel', '01-personnel', 'x_Per_Nationality', 'Per_Nationality', '`Per_Nationality`', '`Per_Nationality`', 3, 2, -1, false, '`Per_Nationality`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Nationality->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Nationality->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Nationality->Lookup = new Lookup('Per_Nationality', 'per_nationality', false, 'Per_Nationality_id', ["Per_Nationality_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Nationality->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Nationality'] = &$this->Per_Nationality;

        // Per_Religion
        $this->Per_Religion = new DbField('_01personnel', '01-personnel', 'x_Per_Religion', 'Per_Religion', '`Per_Religion`', '`Per_Religion`', 3, 2, -1, false, '`Per_Religion`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_Religion->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_Religion->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_Religion->Lookup = new Lookup('Per_Religion', 'per_religion', false, 'Per_Religion_id', ["Per_Religion_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_Religion->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_Religion'] = &$this->Per_Religion;

        // Per_IdCard
        $this->Per_IdCard = new DbField('_01personnel', '01-personnel', 'x_Per_IdCard', 'Per_IdCard', '`Per_IdCard`', '`Per_IdCard`', 200, 13, -1, false, '`Per_IdCard`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_WorkStatus
        $this->Per_WorkStatus = new DbField('_01personnel', '01-personnel', 'x_Per_WorkStatus', 'Per_WorkStatus', '`Per_WorkStatus`', '`Per_WorkStatus`', 3, 2, -1, false, '`Per_WorkStatus`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Per_WorkStatus->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Per_WorkStatus->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->Per_WorkStatus->Lookup = new Lookup('Per_WorkStatus', 'per_workstatus', false, 'Per_WorkStatus_id', ["Per_WorkStatus_name","","",""], [], [], [], [], [], [], '', '');
        $this->Per_WorkStatus->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['Per_WorkStatus'] = &$this->Per_WorkStatus;

        // Per_Phone
        $this->Per_Phone = new DbField('_01personnel', '01-personnel', 'x_Per_Phone', 'Per_Phone', '`Per_Phone`', '`Per_Phone`', 200, 10, -1, false, '`Per_Phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_UPEmail
        $this->Per_UPEmail = new DbField('_01personnel', '01-personnel', 'x_Per_UPEmail', 'Per_UPEmail', '`Per_UPEmail`', '`Per_UPEmail`', 200, 100, -1, false, '`Per_UPEmail`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_Email
        $this->Per_Email = new DbField('_01personnel', '01-personnel', 'x_Per_Email', 'Per_Email', '`Per_Email`', '`Per_Email`', 200, 100, -1, false, '`Per_Email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Per_Address
        $this->Per_Address = new DbField('_01personnel', '01-personnel', 'x_Per_Address', 'Per_Address', '`Per_Address`', '`Per_Address`', 200, 255, -1, false, '`Per_Address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`01-personnel`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Per_major->DbValue = $row['Per_major'];
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("_01personnelList");
        }
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "_01personnelEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "_01personnelAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "_01personnelView";
            case Config("API_ADD_ACTION"):
                return "_01personnelAdd";
            case Config("API_EDIT_ACTION"):
                return "_01personnelEdit";
            case Config("API_DELETE_ACTION"):
                return "_01personnelDelete";
            case Config("API_LIST_ACTION"):
                return "_01personnelList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("_01personnelView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("_01personnelView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "_01personnelAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "_01personnelAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("_01personnelEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("_01personnelAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("_01personnelDelete", $this->getUrlParm());
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Per_major);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Per_major);
