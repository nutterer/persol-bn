 ...
 * Page class
 */
class AcademicpublicDelete extends Academicpublic
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcademicpublicDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AcademicpublicList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AcademicpublicList"); // Return to list
                return;
            }
        }
