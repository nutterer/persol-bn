 ...
 * Page class
 */
class GraduationDelete extends Graduation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GraduationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GraduationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GraduationList"); // Return to list
                return;
            }
        }
