 ...
 * Page class
 */
class SelfdevelopmentView extends Selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SelfdevelopmentView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("SelfDev_Id") ?? Route("SelfDev_Id")) !== null) {
            $this->RecKey["SelfDev_Id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("SelfDev_Id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("SelfDev_Id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("SelfDev_Id") ?? Route("SelfDev_Id")) !== null) {
                ...
                $this->RecKey["SelfDev_Id"] = $this->SelfDev_Id->QueryStringValue;
            } elseif (Post("SelfDev_Id") !== null) {
                $this->SelfDev_Id->setFormValue(Post("SelfDev_Id"));
                $this->RecKey["SelfDev_Id"] = $this->SelfDev_Id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->SelfDev_Id->setQueryStringValue($keyValue);
                $this->RecKey["SelfDev_Id"] = $this->SelfDev_Id->QueryStringValue;
            } else {
                $returnUrl = "SelfdevelopmentList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SelfdevelopmentList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "SelfdevelopmentList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fselfdevelopmentview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fselfdevelopmentview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fselfdevelopmentview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
