 ...
 * Page class
 */
class _03academicranksDelete extends _03academicranks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "_03academicranksDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("_03academicranksList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("_03academicranksList"); // Return to list
                return;
            }
        }
