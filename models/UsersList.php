...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->Users__Id->AdvancedSearch->toJson(), ","); // Field Users _Id
        $filterList = Concat($filterList, $this->Per_Id->AdvancedSearch->toJson(), ","); // Field Per_Id
        $filterList = Concat($filterList, $this->Users_Name->AdvancedSearch->toJson(), ","); // Field Users_Name
        $filterList = Concat($filterList, $this->Users_Password->AdvancedSearch->toJson(), ","); // Field Users_Password
        $filterList = Concat($filterList, $this->Users_Permission->AdvancedSearch->toJson(), ","); // Field Users_Permission
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Users _Id
        $this->Users__Id->AdvancedSearch->SearchValue = @$filter["x_Users__Id"];
        $this->Users__Id->AdvancedSearch->SearchOperator = @$filter["z_Users__Id"];
        $this->Users__Id->AdvancedSearch->SearchCondition = @$filter["v_Users__Id"];
        $this->Users__Id->AdvancedSearch->SearchValue2 = @$filter["y_Users__Id"];
        $this->Users__Id->AdvancedSearch->SearchOperator2 = @$filter["w_Users__Id"];
        $this->Users__Id->AdvancedSearch->save();
        ...
        // Field Users_Name
        $this->Users_Name->AdvancedSearch->SearchValue = @$filter["x_Users_Name"];
        $this->Users_Name->AdvancedSearch->SearchOperator = @$filter["z_Users_Name"];
        $this->Users_Name->AdvancedSearch->SearchCondition = @$filter["v_Users_Name"];
        $this->Users_Name->AdvancedSearch->SearchValue2 = @$filter["y_Users_Name"];
        $this->Users_Name->AdvancedSearch->SearchOperator2 = @$filter["w_Users_Name"];
        $this->Users_Name->AdvancedSearch->save();

        // Field Users_Password
        $this->Users_Password->AdvancedSearch->SearchValue = @$filter["x_Users_Password"];
        $this->Users_Password->AdvancedSearch->SearchOperator = @$filter["z_Users_Password"];
        $this->Users_Password->AdvancedSearch->SearchCondition = @$filter["v_Users_Password"];
        $this->Users_Password->AdvancedSearch->SearchValue2 = @$filter["y_Users_Password"];
        $this->Users_Password->AdvancedSearch->SearchOperator2 = @$filter["w_Users_Password"];
        $this->Users_Password->AdvancedSearch->save();

        // Field Users_Permission
        $this->Users_Permission->AdvancedSearch->SearchValue = @$filter["x_Users_Permission"];
        $this->Users_Permission->AdvancedSearch->SearchOperator = @$filter["z_Users_Permission"];
        $this->Users_Permission->AdvancedSearch->SearchCondition = @$filter["v_Users_Permission"];
        $this->Users_Permission->AdvancedSearch->SearchValue2 = @$filter["y_Users_Permission"];
        $this->Users_Permission->AdvancedSearch->SearchOperator2 = @$filter["w_Users_Permission"];
        $this->Users_Permission->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->Users_Name, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Users_Password, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Users_Permission, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Users__Id); // Users _Id
            $this->updateSort($this->Per_Id); // Per_Id
            $this->updateSort($this->Users_Name); // Users_Name
            $this->updateSort($this->Users_Password); // Users_Password
            $this->updateSort($this->Users_Permission); // Users_Permission
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->Users__Id->setSort("");
                $this->Per_Id->setSort("");
                $this->Users_Name->setSort("");
                $this->Users_Password->setSort("");
                $this->Users_Permission->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->Users__Id->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
