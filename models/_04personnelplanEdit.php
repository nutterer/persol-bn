 ...
 * Page class
 */
class _04personnelplanEdit extends _04personnelplan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "_04personnelplanEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // Plan_File
            $this->Plan_File->setDbValueDef($rsnew, $this->Plan_File->CurrentValue, "", $this->Plan_File->ReadOnly);
