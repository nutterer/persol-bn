 ...
 * Page class
 */
class SelfdevelopmentDelete extends Selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SelfdevelopmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SelfdevelopmentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SelfdevelopmentList"); // Return to list
                return;
            }
        }
