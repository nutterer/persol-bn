 ...
 * Page class
 */
class SelfdevelopmentEdit extends Selfdevelopment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SelfdevelopmentEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // SelfDev_Type
            $this->SelfDev_Type->setDbValueDef($rsnew, $this->SelfDev_Type->CurrentValue, "", $this->SelfDev_Type->ReadOnly);
