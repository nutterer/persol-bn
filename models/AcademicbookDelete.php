 ...
 * Page class
 */
class AcademicbookDelete extends Academicbook
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcademicbookDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AcademicbookList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AcademicbookList"); // Return to list
                return;
            }
        }
