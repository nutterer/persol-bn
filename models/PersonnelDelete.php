 ...
 * Page class
 */
class PersonnelDelete extends Personnel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonnelDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PersonnelList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PersonnelList"); // Return to list
                return;
            }
        }
