 ...
 * Page class
 */
class PersonnelplanDelete extends Personnelplan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonnelplanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PersonnelplanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PersonnelplanList"); // Return to list
                return;
            }
        }
