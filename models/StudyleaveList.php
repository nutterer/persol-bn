 ...
 * Page class
 */
class StudyleaveList extends Studyleave
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'studyleave';

    // Page object name
    public $PageObjName = "StudyleaveList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fstudyleavelist";
    ...
    public function __construct()
    {
        ...
        // Table object (studyleave)
        if (!isset($GLOBALS["studyleave"]) || get_class($GLOBALS["studyleave"]) == PROJECT_NAMESPACE . "studyleave") {
            $GLOBALS["studyleave"] = &$this;
        }
        ...
        $this->AddUrl = "StudyleaveAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "StudyleaveDelete";
        $this->MultiUpdateUrl = "StudyleaveUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'studyleave');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fstudyleavelistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("studyleave"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        $this->Study_Start->setVisibility();
        $this->Study_End->setVisibility();
        $this->StudyLeaveType_Id->setVisibility();
        $this->Study_NumAddTime->setVisibility();
        $this->Study_AddTimeStart->setVisibility();
        $this->Study_AddTimeEnd->setVisibility();
        $this->Study_WorkDate->setVisibility();
        $this->Study_GraduationDate->setVisibility();
        $this->Study_AdjustDate->setVisibility();
        ...
        $this->setupLookupOptions($this->StudyLeaveType_Id);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Study_Start); // Study_Start
            $this->updateSort($this->Study_End); // Study_End
            $this->updateSort($this->StudyLeaveType_Id); // StudyLeaveType_Id
            $this->updateSort($this->Study_NumAddTime); // Study_NumAddTime
            $this->updateSort($this->Study_AddTimeStart); // Study_AddTimeStart
            $this->updateSort($this->Study_AddTimeEnd); // Study_AddTimeEnd
            $this->updateSort($this->Study_WorkDate); // Study_WorkDate
            $this->updateSort($this->Study_GraduationDate); // Study_GraduationDate
            $this->updateSort($this->Study_AdjustDate); // Study_AdjustDate
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Per_Id->setSort("");
                $this->Study_Start->setSort("");
                $this->Study_End->setSort("");
                $this->StudyLeaveType_Id->setSort("");
                $this->Study_NumAddTime->setSort("");
                $this->Study_AddTimeStart->setSort("");
                $this->Study_AddTimeEnd->setSort("");
                $this->Study_WorkDate->setSort("");
                $this->Study_GraduationDate->setSort("");
                $this->Study_AdjustDate->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fstudyleavelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fstudyleavelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fstudyleavelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function newRow()
    {
        ...
        $row['Study_Id'] = null;
        $row['Per_Id'] = null;
        $row['Study_Start'] = null;
        $row['Study_End'] = null;
        $row['StudyLeaveType_Id'] = null;
        $row['Study_NumAddTime'] = null;
        $row['Study_AddTimeStart'] = null;
        $row['Study_AddTimeEnd'] = null;
        $row['Study_WorkDate'] = null;
        $row['Study_GraduationDate'] = null;
        $row['Study_AdjustDate'] = null;
        return $row;
    }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fstudyleavelist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fstudyleavelist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fstudyleavelist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_studyleave" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_studyleave\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fstudyleavelist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
