 ...
 * Page class
 */
class PersonnelEdit extends Personnel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonnelEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // Per_Type
            $this->Per_Type->setDbValueDef($rsnew, $this->Per_Type->CurrentValue, "", $this->Per_Type->ReadOnly);

            // Per_EmployeeType
            $this->Per_EmployeeType->setDbValueDef($rsnew, $this->Per_EmployeeType->CurrentValue, "", $this->Per_EmployeeType->ReadOnly);

            // Per_Position
            $this->Per_Position->setDbValueDef($rsnew, $this->Per_Position->CurrentValue, "", $this->Per_Position->ReadOnly);

            // Per_Academic
            $this->Per_Academic->setDbValueDef($rsnew, $this->Per_Academic->CurrentValue, "", $this->Per_Academic->ReadOnly);

            // Per_Administrative
            $this->Per_Administrative->setDbValueDef($rsnew, $this->Per_Administrative->CurrentValue, "", $this->Per_Administrative->ReadOnly);
            ...
            // Per_WorkStatus
            $this->Per_WorkStatus->setDbValueDef($rsnew, $this->Per_WorkStatus->CurrentValue, "", $this->Per_WorkStatus->ReadOnly);

            // Per_Born
            $this->Per_Born->setDbValueDef($rsnew, UnFormatDateTime($this->Per_Born->CurrentValue, 0), CurrentDate(), $this->Per_Born->ReadOnly);

            // Per_Nationality
            $this->Per_Nationality->setDbValueDef($rsnew, $this->Per_Nationality->CurrentValue, "", $this->Per_Nationality->ReadOnly);

            // Per_Religion
            $this->Per_Religion->setDbValueDef($rsnew, $this->Per_Religion->CurrentValue, "", $this->Per_Religion->ReadOnly);
