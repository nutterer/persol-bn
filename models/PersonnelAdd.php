 ...
 * Page class
 */
class PersonnelAdd extends Personnel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PersonnelAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PersonnelList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PersonnelList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PersonnelView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->Per_ThaiPre->CurrentValue = null;
        $this->Per_ThaiPre->OldValue = $this->Per_ThaiPre->CurrentValue;
        $this->Per_ThaiName->CurrentValue = null;
        $this->Per_ThaiName->OldValue = $this->Per_ThaiName->CurrentValue;
        $this->Per_ThaiLastName->CurrentValue = null;
        $this->Per_ThaiLastName->OldValue = $this->Per_ThaiLastName->CurrentValue;
        $this->Per_EngPre->CurrentValue = null;
        $this->Per_EngPre->OldValue = $this->Per_EngPre->CurrentValue;
        $this->Per_EngName->CurrentValue = null;
        $this->Per_EngName->OldValue = $this->Per_EngName->CurrentValue;
        $this->Per_EngLastName->CurrentValue = null;
        $this->Per_EngLastName->OldValue = $this->Per_EngLastName->CurrentValue;
        $this->Per_Type->CurrentValue = null;
        $this->Per_Type->OldValue = $this->Per_Type->CurrentValue;
        $this->Per_EmployeeType->CurrentValue = null;
        $this->Per_EmployeeType->OldValue = $this->Per_EmployeeType->CurrentValue;
        $this->Per_Position->CurrentValue = null;
        $this->Per_Position->OldValue = $this->Per_Position->CurrentValue;
        $this->Per_Academic->CurrentValue = null;
        $this->Per_Academic->OldValue = $this->Per_Academic->CurrentValue;
        $this->Per_Administrative->CurrentValue = null;
        $this->Per_Administrative->OldValue = $this->Per_Administrative->CurrentValue;
        $this->Per_WorDateStart->CurrentValue = null;
        $this->Per_WorDateStart->OldValue = $this->Per_WorDateStart->CurrentValue;
        $this->Per_WorkDate->CurrentValue = null;
        $this->Per_WorkDate->OldValue = $this->Per_WorkDate->CurrentValue;
        $this->Per_WorkStatus->CurrentValue = null;
        $this->Per_WorkStatus->OldValue = $this->Per_WorkStatus->CurrentValue;
        $this->Per_Born->CurrentValue = null;
        $this->Per_Born->OldValue = $this->Per_Born->CurrentValue;
        $this->Per_Nationality->CurrentValue = null;
        $this->Per_Nationality->OldValue = $this->Per_Nationality->CurrentValue;
        $this->Per_Religion->CurrentValue = null;
        $this->Per_Religion->OldValue = $this->Per_Religion->CurrentValue;
        $this->Per_IdCard->CurrentValue = null;
        $this->Per_IdCard->OldValue = $this->Per_IdCard->CurrentValue;
        $this->Per_Phone->CurrentValue = null;
        $this->Per_Phone->OldValue = $this->Per_Phone->CurrentValue;
        $this->Per_UPEmail->CurrentValue = null;
        $this->Per_UPEmail->OldValue = $this->Per_UPEmail->CurrentValue;
        $this->Per_Email->CurrentValue = null;
        $this->Per_Email->OldValue = $this->Per_Email->CurrentValue;
        $this->Per_Address->CurrentValue = null;
        $this->Per_Address->OldValue = $this->Per_Address->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['Per_ThaiPre'] = $this->Per_ThaiPre->CurrentValue;
        $row['Per_ThaiName'] = $this->Per_ThaiName->CurrentValue;
        $row['Per_ThaiLastName'] = $this->Per_ThaiLastName->CurrentValue;
        $row['Per_EngPre'] = $this->Per_EngPre->CurrentValue;
        $row['Per_EngName'] = $this->Per_EngName->CurrentValue;
        $row['Per_EngLastName'] = $this->Per_EngLastName->CurrentValue;
        $row['Per_Type'] = $this->Per_Type->CurrentValue;
        $row['Per_EmployeeType'] = $this->Per_EmployeeType->CurrentValue;
        $row['Per_Position'] = $this->Per_Position->CurrentValue;
        $row['Per_Academic'] = $this->Per_Academic->CurrentValue;
        $row['Per_Administrative'] = $this->Per_Administrative->CurrentValue;
        $row['Per_WorDateStart'] = $this->Per_WorDateStart->CurrentValue;
        $row['Per_WorkDate'] = $this->Per_WorkDate->CurrentValue;
        $row['Per_WorkStatus'] = $this->Per_WorkStatus->CurrentValue;
        $row['Per_Born'] = $this->Per_Born->CurrentValue;
        $row['Per_Nationality'] = $this->Per_Nationality->CurrentValue;
        $row['Per_Religion'] = $this->Per_Religion->CurrentValue;
        $row['Per_IdCard'] = $this->Per_IdCard->CurrentValue;
        $row['Per_Phone'] = $this->Per_Phone->CurrentValue;
        $row['Per_UPEmail'] = $this->Per_UPEmail->CurrentValue;
        $row['Per_Email'] = $this->Per_Email->CurrentValue;
        $row['Per_Address'] = $this->Per_Address->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Per_Type->EditValue = HtmlEncode($this->Per_Type->CurrentValue);
            ...
            $this->Per_EmployeeType->EditValue = HtmlEncode($this->Per_EmployeeType->CurrentValue);
            ...
            $this->Per_Position->EditValue = HtmlEncode($this->Per_Position->CurrentValue);
            ...
            $this->Per_Academic->EditValue = HtmlEncode($this->Per_Academic->CurrentValue);
            ...
            $this->Per_Administrative->EditValue = HtmlEncode($this->Per_Administrative->CurrentValue);
            ...
            $this->Per_WorkStatus->EditValue = HtmlEncode($this->Per_WorkStatus->CurrentValue);
            ...
            $this->Per_Nationality->EditValue = HtmlEncode($this->Per_Nationality->CurrentValue);
            ...
            $this->Per_Religion->EditValue = HtmlEncode($this->Per_Religion->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Per_ThaiPre
        $this->Per_ThaiPre->setDbValueDef($rsnew, $this->Per_ThaiPre->CurrentValue, "", false);

        // Per_ThaiName
        $this->Per_ThaiName->setDbValueDef($rsnew, $this->Per_ThaiName->CurrentValue, "", false);

        // Per_ThaiLastName
        $this->Per_ThaiLastName->setDbValueDef($rsnew, $this->Per_ThaiLastName->CurrentValue, "", false);

        // Per_EngPre
        $this->Per_EngPre->setDbValueDef($rsnew, $this->Per_EngPre->CurrentValue, "", false);

        // Per_EngName
        $this->Per_EngName->setDbValueDef($rsnew, $this->Per_EngName->CurrentValue, "", false);

        // Per_EngLastName
        $this->Per_EngLastName->setDbValueDef($rsnew, $this->Per_EngLastName->CurrentValue, "", false);

        // Per_Type
        $this->Per_Type->setDbValueDef($rsnew, $this->Per_Type->CurrentValue, "", false);

        // Per_EmployeeType
        $this->Per_EmployeeType->setDbValueDef($rsnew, $this->Per_EmployeeType->CurrentValue, "", false);

        // Per_Position
        $this->Per_Position->setDbValueDef($rsnew, $this->Per_Position->CurrentValue, "", false);

        // Per_Academic
        $this->Per_Academic->setDbValueDef($rsnew, $this->Per_Academic->CurrentValue, "", false);

        // Per_Administrative
        $this->Per_Administrative->setDbValueDef($rsnew, $this->Per_Administrative->CurrentValue, "", false);

        // Per_WorDateStart
        $this->Per_WorDateStart->setDbValueDef($rsnew, UnFormatDateTime($this->Per_WorDateStart->CurrentValue, 0), CurrentDate(), false);

        // Per_WorkDate
        $this->Per_WorkDate->setDbValueDef($rsnew, UnFormatDateTime($this->Per_WorkDate->CurrentValue, 0), CurrentDate(), false);

        // Per_WorkStatus
        $this->Per_WorkStatus->setDbValueDef($rsnew, $this->Per_WorkStatus->CurrentValue, "", false);

        // Per_Born
        $this->Per_Born->setDbValueDef($rsnew, UnFormatDateTime($this->Per_Born->CurrentValue, 0), CurrentDate(), false);

        // Per_Nationality
        $this->Per_Nationality->setDbValueDef($rsnew, $this->Per_Nationality->CurrentValue, "", false);

        // Per_Religion
        $this->Per_Religion->setDbValueDef($rsnew, $this->Per_Religion->CurrentValue, "", false);

        // Per_IdCard
        $this->Per_IdCard->setDbValueDef($rsnew, $this->Per_IdCard->CurrentValue, "", false);

        // Per_Phone
        $this->Per_Phone->setDbValueDef($rsnew, $this->Per_Phone->CurrentValue, "", false);

        // Per_UPEmail
        $this->Per_UPEmail->setDbValueDef($rsnew, $this->Per_UPEmail->CurrentValue, "", false);

        // Per_Email
        $this->Per_Email->setDbValueDef($rsnew, $this->Per_Email->CurrentValue, "", false);

        // Per_Address
        $this->Per_Address->setDbValueDef($rsnew, $this->Per_Address->CurrentValue, "", false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['Per_Id']) == "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PersonnelList"), "", $this->TableVar, true);
