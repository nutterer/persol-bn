...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'VamBn9T55CXktVBl', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/upPersonnelv2.css", // Project stylesheet file name
    ...
    "ADMIN_USER_NAME" => "tong", // Administrator user name
    "ADMIN_PASSWORD" => "tong", // Administrator password
