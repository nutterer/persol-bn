...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "Griktgik@30121978", "dbname" => "uppersonnel_db"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "xfwQw246P5kp93HD", // API Secret Key
